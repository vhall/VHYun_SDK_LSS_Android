...
public class PushActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        frameRate = getIntent().getIntExtra("frameRate", 15);
        bitRate = getIntent().getIntExtra("bitRate", 1500);
        dpi = getIntent().getIntExtra("dpi", 2);
        ...
        //配置发直播系列参数
        config = new VHLivePushConfig(dpi);//VHLivePushFormat.PUSH_MODE_HD(480p)  VHLivePushFormat.PUSH_MODE_XXHD(720p) VHLivePushFormat.PUSH_MODE_XXHD(1080p)
        ...
        config.videoBitrate = bitRate * 1000;
